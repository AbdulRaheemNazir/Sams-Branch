...
// import LoginSuccessfulScreen from '../LoginSuccessfulScreen';
...
//   const handleLogin = async () => {
//     try {
//       const response = await axios.post('http://192.168.218.38:8080/api/watson', {
//         text: text,
//       });
//       setMessage('worked'); // Clear any previous error messages
//     } catch (error) {
//       setMessage('failed');
//     }
//   };
...
//       <Text style={[styles.message, message === 'failed' && styles.errorMessage]}>{message}</Text>
